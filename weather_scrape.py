...
try:
    driver.get("https://www.timeanddate.com/weather/?low=4")
...
for pair in weather_pairs:
    try:
        ...
        for city, url, date_time, weather_description, temperature in zip(cities, urls, date_times, weather_descriptions, temperatures):
            weather_data.append({
                'city': city,
                'url': url,
                'date_time': date_time,
